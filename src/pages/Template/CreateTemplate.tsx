  ...
  const onFinish = useCallback(
    (form: any) => {
      ...
      trackingAsync(
        () =>
          dispatch(
            temPlateApi.endpoints.insertEmailTemplate.initiate(req) as any
          ),
        {
          onSuccess: (res) => {
        ...
        <Translation>
          {(t) => (
            <Label className="text-gray-900 text-2xl font-bold">
              {t("page.template.pageNameCreate")}
            </Label>
          )}
        </Translation>
      </div>
        ...
        <ContentCard>
          <div className="flex flex-col p-8">
            <div className="grid grid-cols-2 gap-8">
              ...
              >
                <TextInput placeholder="Template Name" type="text" />
              </FormItem>
          ...
          <div className="flex flex-row p-8 gap-4">
            ...
            >
              <TestSendEmailForm content={itemContent} />
            </BtnModal>
          </div>
        </ContentCard>
      </div>
